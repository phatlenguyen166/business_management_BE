...
CREATE TABLE `staff_statistic_of_month` (
  ...
  `promoted_employees` int NOT NULL,
  `resigned_employees` int NOT NULL,
...
-- Dump completed on 2025-05-03 15:55:14
